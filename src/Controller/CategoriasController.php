...
class CategoriasController extends AppController
{
    ...
    public function crear()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Categorias->save($categoria)) {
                $this->Flash->success(__('Los datos de la nueva categoría han sido guardados.'));
    ...
    public function editar($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            $categoria = $this->Categorias->patchEntity($categoria, $this->request->getData());
            if ($this->Categorias->save($categoria)) {
                $this->Flash->success(__('Los datos de la categoría han sido actualizados.'));
    ...
    public function eliminar($id = null)
    {
        ...
        if ($this->Categorias->delete($categoria)) {
            $this->Flash->success(__('La categoría ha sido eliminada del registro.'));
        } else {
            $this->Flash->error(__('Algo ha fallado. Inténtelo de nuevo..'));
        }
