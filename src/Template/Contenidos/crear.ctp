...
<div class="content-box-large">
    ...
    <div class="panel-heading">
     ...
     <!--        <label for="calendario">Inicio</label>
            <input type="date" id="calendario" name="fecha_ini">   
            <div class="panel-body">
                <h5>Inicio</h5>
                <p>
                    <div class="bfh-datepicker" id="calendario" name="fecha_ini" data-format="y-m-d" data-date="today"></div>
                </p>
                <h5>Fin</h5>
                <p>
                    <div class="bfh-datepicker" id="calendario" name="fecha_fin" data-format="y-m-d" data-date="today"></div>
                </p>
            </div>   -->
