...
class TecnicosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'apelldos' => ['type' => 'string', 'length' => 80, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'tipo' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8_spanish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'apelldos' => 'Lorem ipsum dolor sit amet',
                'tipo' => 'Lorem ipsum dolor ',
                'direccion' => 'Lorem ipsum dolor sit amet',
                'email' => 'Lorem ipsum dolor sit amet',
                'fecha_add' => '2018-10-26 12:05:33',
                'fecha_mod' => '2018-10-26 12:05:33'
            ],
        ];
        parent::init();
    }
