...
class CategoriasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'tipo' => ['type' => 'string', 'length' => 30, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'fecha_add' => '2018-11-06 10:17:52',
                'fecha_mod' => '2018-11-06 10:17:52'
            ],
        ];
        parent::init();
    }
