...
class ProyectosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nombre_app' => ['type' => 'string', 'length' => 60, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'id_estado' => 1,
                'id_cliente' => 1,
                'nombre_app' => 'Lorem ipsum dolor sit amet',
                'descripcion' => 'Lorem ipsum dolor sit amet',
                'fecha_add' => '2018-10-29 11:54:39',
                'fecha_mod' => '2018-10-29 11:54:39'
            ],
        ];
        parent::init();
    }
